...
private:
    ...
    cl::NDRange update_lr_global_size[3];
    cl::NDRange update_ud_global_size[3];
    cl::NDRange update_lr_local_size[3];
    cl::NDRange update_ud_local_size[3];
...
public:
    ...
    void update_halo_kernel(const int* chunk_neighbours, const int* fields, int depth);
    void update_array
    (cl::Buffer& cur_array,
