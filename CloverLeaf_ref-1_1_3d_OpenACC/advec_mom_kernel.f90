...
!$ACC DATA &
!$ACC COPY(vel1) &
!$ACC COPY(volume,mass_flux_x,mass_flux_y,vol_flux_x,vol_flux_y,density1,celldx,celldy,mass_flux_z) &
!$ACC COPY(mom_flux,advec_vel,node_flux,node_mass_post,node_mass_pre,post_vol,pre_vol,celldz,vol_flux_z)
