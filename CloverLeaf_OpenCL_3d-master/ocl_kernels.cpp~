...
(void)
{
    ...
    options << "-Dy_min=" << z_min << " ";
    options << "-Dy_max=" << z_max << " ";
    ...
    compileKernel(options_str, src_flux_calc_cl, "flux_calc_z", flux_calc_z_device);
...
//    compileKernel(options_str, src_update_halo_cl, "update_halo_front", update_halo_front_device);
    ...
    compileKernel(options_str, src_advec_mom_cl, "advec_mom_node_flux_post_z_1", advec_mom_node_flux_post_z_1_device);
    compileKernel(options_str, src_advec_mom_cl, "advec_mom_node_flux_post_z_2", advec_mom_node_flux_post_z_2_device);
    compileKernel(options_str, src_advec_mom_cl, "advec_mom_node_pre_z", advec_mom_node_pre_z_device);
    compileKernel(options_str, src_advec_mom_cl, "advec_mom_flux_z", advec_mom_flux_z_device);
    compileKernel(options_str, src_advec_mom_cl, "advec_mom_zvel", advec_mom_zvel_device);
    ...
    compileKernel(options_str, src_advec_cell_cl, "advec_cell_pre_vol_z", advec_cell_pre_vol_z_device);
    compileKernel(options_str, src_advec_cell_cl, "advec_cell_ener_flux_z", advec_cell_ener_flux_z_device);
    compileKernel(options_str, src_advec_cell_cl, "advec_cell_z", advec_cell_z_device);
